...
var Cheerio = module.exports = function Cheerio(selector, context, root) {
  ...
  // $(<html>)
  if (typeof selector === 'string' && Cheerio.isHtml(selector)) {
...
Cheerio.isHtml = function isHtml(str) {
...
Cheerio.prototype.make = function make(dom, context) {
...
Cheerio.prototype.toArray = function toArray() {
