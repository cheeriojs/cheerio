 ...
 */
var loadWithCheerio = function (Cheerio, content, options, isDocument) {
  ...
  // For deprecated API
  initialize.load = initialize.loadWithCheerio.bind(null, Cheerio);
...
exports.loadWithCheerio = loadWithCheerio;
...
exports.parseHTML = function (data, context, keepScripts) {
  ...
  var parsed = loadWithCheerio(this, data, defaultOptions, false);
  if (!keepScripts) {
