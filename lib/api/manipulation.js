 ...
 * several levels deep, but should contain only one inmost element. The structure
 * will be wrapped around all of the elements in the set of matched elements,
 * as a single group.
 *
 * @param {cheerio} wrapper - The DOM structure to wrap around all matched elements in the selection.
 *
 * @example
 *
 * const $ = cheerio.load('<div class="container"><div class="inner">First</div><div class="inner">Second</div></div>')
 ...
 * //   </div>
 *
 * const $ = cheerio.load('<span>Span 1</span><strong>Strong</strong><span>Span 2</span>');
...
exports.wrapAll = function (wrapper) {
  ...
  if (this[0]) {
    ...
    elInsertLocation = { children: wrap };
