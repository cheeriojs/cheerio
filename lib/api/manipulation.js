...
var _insert = function(concatenator) {
  return function() {
    ...
    if(elems.length == 1 && !elems[0].cheerio && !$.isHtml(elems[0])) {
    	elems = Cheerio(elems[0]); // in case argument is a jquery selector, i.e. 'div.fancyClass'
    }
    var   dom = $.makeCheerioArray(elems);
...
var off = exports.off = function(){console.warn('Not implemented');};
var on = exports.on = function(){console.warn('Not implemented');};