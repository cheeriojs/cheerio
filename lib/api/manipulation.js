(function() {
  var $, after, append, before, clone, empty, html, parse, prepend, remove, removeChild, replaceWith, text, _,
  ...
  replaceWith = exports.replaceWith = function(content) {
    var elems;
    elems = typeof content !== "object" ? parse.eval(content) : content;
    this.each(function() {
      var index, siblings;
      siblings = this.parent.children;
      index = siblings.indexOf(this);
  ...
  clone = exports.clone = function() {
    ...
    for (_i = 0, _len = this.length; _i < _len; _i++) {
      elem = this[_i];
      result = result.concat(parse.eval($.html(elem)).toArray);
    }
    return $(result);
  };
