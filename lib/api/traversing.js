...
exports.parentsUntil = function (selector, filter) {
  ...
  if (typeof selector === 'string') {
    untilNode = select.selectAll(selector, this.parents().toArray(), this.options)[0];
...
exports.nextUntil = function (selector, filterSelector) {
  ...
  if (typeof selector === 'string') {
    untilNode = select.selectAll(selector, this.nextAll().get(), this.options)[0];
  } else if (selector && selector.cheerio) {
...
exports.prevUntil = function (selector, filterSelector) {
  ...
  if (typeof selector === 'string') {
    untilNode = select.selectAll(selector, this.prevAll().get(), this.options)[0];
  } else if (selector && selector.cheerio) {
    untilNodes = selector.get();
  } else if (selector) {
    untilNode = selector;
