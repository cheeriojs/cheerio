...
var each = exports.each = function(fn, args) {
  var cb = function(a, b) { return fn.call(this, b, a); };
  return _.each(this, cb, this);
};

var map = exports.map = function(fn, args) {
  var cb = function(a, b) { return fn.call(this, b, a); };
  return _.map(this, cb, this);
};
...
var eq = exports.eq = function(i) {
  ...
  return this[i] ? this.make(this[i]) : this;
};
