...
exports.find = function(selectorOrHaystack) {
  var elems = Object.keys(this).reduce((memo, k) => {
    var elem = this[k]
...
exports.siblings = function(selector) {
  ...
  var root = parent ? parent.children() : this.siblingsAndMe();
  var elems = Object.keys(root)
...
exports.children = function(selector) {
  var elems = Object.keys(this).reduce((memo, k, i, arr) => {
    var elem = this[k]
    if (elem.children && elem.children.filter)
      return memo.concat(elem.children.filter(isTag));
...
var makeFilterMethod = function(filterFn, neg) {
