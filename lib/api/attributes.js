...
function setAttr(el, name, value) {
  ...
  // Remove an attribute if we set attribute to null
  if(value === null) {
    delete el.attribs[name];
  } else if (typeof name === 'object') {
    el.attribs = _.extend(el.attribs, value);
  } else {
    el.attribs[name] = encode(value);
  }
  // else if(typeof value === 'object') _.extend(el.attribs, value);
  // else el.attribs[name] = encode(value);
}
