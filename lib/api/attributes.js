...
/**
 * Get the Data attribute. Added to better match jQuery
 */
...
var data = exports.data = function(name, value) {
        ...
        if (typeof name === 'object' || value !== undefined) {
                this.each(function(i, el) {
                        el.attribs = setAttr(el, "data-" + name, value);
                });
                return this;
        } else if (Object.hasOwnProperty.call(elem.attribs, "data-" + name)) {
                // Get the (decoded) attribute
                return decode(elem.attribs["data-" + name]);
        }
}
...
var removeClass = exports.removeClass = function(value) {
        ...
        return this.each(function(i, el) {
                ...
                el.attribs['class'] = (!value) ? '' : _.reject(
                        ...
                        function(name) {
                                return _.contains(classes, name);
                        }
                ).join(' ');
        });
};