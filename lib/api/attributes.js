...
var data = exports.data = function(name, value) {
  ...
  // FIXME - add check to automatically import HTML5 -data attributes here
  ...
  if (!name) {
    ...
    // If an object is supplied, extend each element's data   
    this.each(function(i, el) {
      el.data = _.extend(el.data, name);
    });
    return this;
