...
attributes.attr = function attr(name, value) {
  var elem = this[0];
...
attributes.removeAttr = function removeAttr(name) {
...
attributes.hasClass = function hasClass(className) {
...
attributes.addClass = function addClass(value) {
  // Support functions
...
attributes.removeClass = function removeClass(value) {
  var split = function split(className) {
