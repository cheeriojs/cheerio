...
/*
  Format attributes
*/
var formatAttrs = function formatAttrs(attributes) {
...
var render = module.exports = function render(dom, opts) {
...
var renderTag = function renderTag(elem) {
  var tag = '<' + elem.name;
...
var renderDirective = function renderDirective(elem) {
  return '<' + elem.data + '>';
};

var renderText = function renderText(elem) {
  return elem.data;
};

var renderComment = function renderComment(elem) {
  return '<!--' + elem.data + '-->';
};
