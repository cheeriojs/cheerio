 ...
 * @param {Object|string} t - includes <script> and <style> tags
 */
exports.isTag = function (t) {
  const type = t.type ? t.type : t
 ...
 * instances. This is indented for use internally to avoid otherwise
 * unnecessary memory pressure introduced by _make.
 */
 ...
 * @param {Object} options - The parsing/rendering options
 */
