...
/**
 * Walk up the tree invalidating any html cache that may have been saved off.
 */

exports.invalidate = function(cheerio) {
  while (cheerio && cheerio._html) {
    cheerio._html = undefined;
    cheerio._endIndex = cheerio._startIndex = 0;
    cheerio = cheerio.parent;
  }
};
