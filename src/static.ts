...
const renderWithParse5 = require('./parsers/parse5').render;
const renderWithHtmlparser2 = require('./parsers/htmlparser2').render;
...
exports.xml = function (dom) {
  const options = Object.assign({}, this._options, { xmlMode: true });
