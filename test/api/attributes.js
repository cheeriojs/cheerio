...
describe('$(...)', () => {
  ...
  describe('.attr', () => {
    ...
    it('(map) : should remove attributes with null values', () => {
      const $pear = $('.pear').attr({autofocus: 'autofocus', style: 'color:red'})
      expect($pear.attr('autofocus')).to.equal('autofocus')
  ...
  describe('.data', () => {
    ...
    it('(key) : should translate camel-cased key values to hyphen-separated versions', () => {
      const $el = cheerio('<div data--three-word-attribute="a" data-foo-Bar_BAZ-="b">')
  ...
  describe('.is', () => {
    ...
    it('(false predicate) : should return false', () => {
      const result = $('li').last().is(function () {
